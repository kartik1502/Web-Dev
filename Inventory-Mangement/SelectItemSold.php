...
. mysqli_connect_error());
        ...
        if(mysqli_num_rows($result)<=0)
        {
            ...
            echo "<center>";
                ...
                echo '<h1 style="font-size: 40px">Item Sold Details</h1>';
                echo '</form>';
                echo '<div class="table-wrapper">';
                echo '<table class="fl-table">';
                echo '<thread><tr><th>Customer Id</th><th>Product Id</th><th>Product Name</th><th>Brand Name</th><th>Quantity Ordered</th></tr></thread>'."<br>";
                while($row=mysqli_fetch_assoc($result))
                {
                    echo "<tr><td>".$row['Cust_id']."</td><td>".$row['Prod_id']."</td><td>".$row['Prod_Name']."</td><td>".$row['Brnd_Name']."</td><td>".$row['Cust_Quantity']. "</td></tr>";
                }
                echo "</table>";
                echo "</div>";
                echo "</center>";
