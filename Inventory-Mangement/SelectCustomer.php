...
. mysqli_connect_error());
        ...
        if(mysqli_num_rows($result)<=0)
        {
            ...
            echo "<center>";
                ...
                echo '<h1 style="font-size: 40px">Customer Details</h1>';
                echo '</form>';
                echo '<div class="table-wrapper">';
                echo '<table class="fl-table">';
                echo '<thread><tr><th>Customer ID</th><th>First Name</th><th>Last Name</th><th>Place</th><th>Contact Number</th><th>Email Id</th></tr></thread>'."<br>";
                while($row=mysqli_fetch_assoc($result))
                {
                    echo "<tr><td>".$row['Cust_id']."</td><td>".$row['FName']."</td><td>".$row['LName']."</td><td>".$row['address']."</td><td>" .$row['Contact_No']. "</td><td>".$row['Email_id']. "</td></tr>";
                }
                echo "</table>";
                echo "</div>";
                echo "</center>";
