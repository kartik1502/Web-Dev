...
. mysqli_connect_error());
        ...
        if(mysqli_num_rows($result)<=0)
        {
            ...
            echo "<center>";
                ...
                echo '<h1 style="font-size: 40px">Supplier Details</h1>';
                echo '</form>';
                echo '<div class="table-wrapper">';
                echo '<table class="fl-table">';
                echo '<thread><tr><th>Supplier ID</th><th>Supplier Name</th><th>Location</th><th>Contact Number</th><th>Email Id</th><th>Company</th></tr></thread>'."<br>";
                while($row=mysqli_fetch_assoc($result))
                {
                    echo "<tr><td>".$row['Sup_id']."</td><td>".$row['Sup_Name']."</td><td>".$row['Location']."</td><td>".$row['Contact_No']."</td><td>" .$row['Email_id']. "</td><td>".$row['Company']. "</td></tr>";
                }
                echo "</table>";
                echo "</div>";
                echo "</center>";
